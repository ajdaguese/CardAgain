...
public class War {
	...
	public void GameOver()
	{
		if(player1Win)
		{
			gameServer.broadcastCommandToAll(new EndGameCommand(player1.getName()));
		}
		else if(player2Win)
		{
			gameServer.broadcastCommandToAll(new EndGameCommand(player2.getName()));
		}
	}
	...
	public WarPlayer connectPlayer(UUID uuid, User user){
		...
		WarPlayer temp = new WarPlayer(playerName, uuid);
